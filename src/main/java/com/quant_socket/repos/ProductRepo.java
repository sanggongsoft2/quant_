...
public class ProductRepo extends SG_repo<Product>{
    ...
    private final String productDayUpdateSql = "UPDATE product_day d_for_ask_count = ?, d_for_bid_count = ?, d_fac_ask_count = ?, d_fac_bid_count = ?";
    ...
    public void updateProductDay(Product prod) {
        jt.update(productDayUpdateSql, prod.getForeignerAskCount(), prod.getForeignerBidCount(), prod.getFacilityAskCount(), prod.getFacilityBidCount());
    }
