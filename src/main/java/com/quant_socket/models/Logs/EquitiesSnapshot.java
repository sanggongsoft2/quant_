...
public class EquitiesSnapshot extends SG_model {
    ...
    public EquitiesSnapshot(String msg) {
        ...
        if(!msg.substring(28, 39).isBlank()) price_change_against_the_previous_day = BigDecimal.valueOf(Double.parseDouble(msg.substring(28, 39)));
        if(!msg.substring(39, 50).isBlank()) upper_limit_price = BigDecimal.valueOf(Double.parseDouble(msg.substring(39, 50)));
        if(!msg.substring(50, 61).isBlank()) lower_limit_price = BigDecimal.valueOf(Double.parseDouble(msg.substring(50, 61)));
        if(!msg.substring(61, 72).isBlank()) current_price = BigDecimal.valueOf(Double.parseDouble(msg.substring(61, 72)));
        if(!msg.substring(72, 83).isBlank()) opening_price = BigDecimal.valueOf(Double.parseDouble(msg.substring(72, 83)));
        if(!msg.substring(83, 94).isBlank()) todays_high = BigDecimal.valueOf(Double.parseDouble(msg.substring(83, 94)));
        if(!msg.substring(94, 105).isBlank()) todays_low = BigDecimal.valueOf(Double.parseDouble(msg.substring(94, 105)));
        ...
        if(msg.length() >= 899) {
            if(!msg.substring(140, 151).isBlank()) ask_level_1_price = BigDecimal.valueOf(Double.parseDouble(msg.substring(140, 151)));
            if(!msg.substring(151, 162).isBlank()) bid_level_1_price = BigDecimal.valueOf(Double.parseDouble(msg.substring(151, 162)));
            ...
            if(!msg.substring(210, 221).isBlank()) ask_level_2_price = BigDecimal.valueOf(Double.parseDouble(msg.substring(210, 221)));
            if(!msg.substring(221, 232).isBlank()) bid_level_2_price = BigDecimal.valueOf(Double.parseDouble(msg.substring(221, 232)));
            ...
            if(!msg.substring(280, 291).isBlank()) ask_level_3_price = BigDecimal.valueOf(Double.parseDouble(msg.substring(280, 291)));
            if(!msg.substring(291, 302).isBlank()) bid_level_3_price = BigDecimal.valueOf(Double.parseDouble(msg.substring(291, 302)));
            ...
            if(!msg.substring(350, 361).isBlank()) ask_level_4_price = BigDecimal.valueOf(Double.parseDouble(msg.substring(350, 361)));
            if(!msg.substring(361, 372).isBlank()) bid_level_4_price = BigDecimal.valueOf(Double.parseDouble(msg.substring(361, 372)));
            ...
            if(!msg.substring(420, 431).isBlank()) ask_level_5_price = BigDecimal.valueOf(Double.parseDouble(msg.substring(420, 431)));
            if(!msg.substring(431, 442).isBlank()) bid_level_5_price = BigDecimal.valueOf(Double.parseDouble(msg.substring(431, 442)));
            ...
            if(!msg.substring(490, 501).isBlank()) ask_level_6_price = BigDecimal.valueOf(Double.parseDouble(msg.substring(490, 501)));
            if(!msg.substring(501, 512).isBlank()) bid_level_6_price = BigDecimal.valueOf(Double.parseDouble(msg.substring(501, 512)));
            ...
            if(!msg.substring(560, 571).isBlank()) ask_level_7_price = BigDecimal.valueOf(Double.parseDouble(msg.substring(560, 571)));
            if(!msg.substring(571, 582).isBlank()) bid_level_7_price = BigDecimal.valueOf(Double.parseDouble(msg.substring(571, 582)));
            ...
            if(!msg.substring(630, 641).isBlank()) ask_level_8_price = BigDecimal.valueOf(Double.parseDouble(msg.substring(630, 641)));
            if(!msg.substring(641, 652).isBlank()) bid_level_8_price = BigDecimal.valueOf(Double.parseDouble(msg.substring(641, 652)));
            ...
            if(!msg.substring(700, 711).isBlank()) ask_level_9_price = BigDecimal.valueOf(Double.parseDouble(msg.substring(700, 711)));
            if(!msg.substring(711, 722).isBlank()) bid_level_9_price = BigDecimal.valueOf(Double.parseDouble(msg.substring(711, 722)));
            ...
            if(!msg.substring(770, 781).isBlank()) ask_level_10_price = BigDecimal.valueOf(Double.parseDouble(msg.substring(770, 781)));
            if(!msg.substring(781, 792).isBlank()) bid_level_10_price = BigDecimal.valueOf(Double.parseDouble(msg.substring(781, 792)));
            ...
            if(!msg.substring(864, 875).isBlank()) estimated_trading_price = BigDecimal.valueOf(Double.parseDouble(msg.substring(864, 875)));
            ...
            if(!msg.substring(162, 174).isBlank()) ask_level_1_volume = Long.parseLong(msg.substring(162, 174));
            if(!msg.substring(174, 186).isBlank()) bid_level_1_volume = Long.parseLong(msg.substring(174, 186));
            if(!msg.substring(186, 197).isBlank()) ask_level_2_price = BigDecimal.valueOf(Double.parseDouble(msg.substring(186, 197)));
            if(!msg.substring(197, 208).isBlank()) bid_level_2_price = BigDecimal.valueOf(Double.parseDouble(msg.substring(197, 208)));
            ...
            if(!msg.substring(232, 243).isBlank()) ask_level_3_price = BigDecimal.valueOf(Double.parseDouble(msg.substring(232, 243)));
            if(!msg.substring(243, 254).isBlank()) bid_level_3_price = BigDecimal.valueOf(Double.parseDouble(msg.substring(243, 254)));
            ...
            if(!msg.substring(278, 289).isBlank()) ask_level_4_price = BigDecimal.valueOf(Double.parseDouble(msg.substring(278, 289)));
            if(!msg.substring(289, 300).isBlank()) bid_level_4_price = BigDecimal.valueOf(Double.parseDouble(msg.substring(289, 300)));
            ...
            if(!msg.substring(324, 335).isBlank()) ask_level_5_price = BigDecimal.valueOf(Double.parseDouble(msg.substring(324, 335)));
            if(!msg.substring(335, 346).isBlank()) bid_level_5_price = BigDecimal.valueOf(Double.parseDouble(msg.substring(335, 346)));
            ...
            if(!msg.substring(370, 381).isBlank()) ask_level_6_price = BigDecimal.valueOf(Double.parseDouble(msg.substring(370, 381)));
            if(!msg.substring(381, 392).isBlank()) bid_level_6_price = BigDecimal.valueOf(Double.parseDouble(msg.substring(381, 392)));
            ...
            if(!msg.substring(416, 427).isBlank()) ask_level_7_price = BigDecimal.valueOf(Double.parseDouble(msg.substring(416, 427)));
            if(!msg.substring(427, 438).isBlank()) bid_level_7_price = BigDecimal.valueOf(Double.parseDouble(msg.substring(427, 438)));
            ...
            if(!msg.substring(462, 473).isBlank()) ask_level_8_price = BigDecimal.valueOf(Double.parseDouble(msg.substring(462, 473)));
            if(!msg.substring(473, 484).isBlank()) bid_level_8_price = BigDecimal.valueOf(Double.parseDouble(msg.substring(473, 484)));
            ...
            if(!msg.substring(508, 519).isBlank()) ask_level_9_price = BigDecimal.valueOf(Double.parseDouble(msg.substring(508, 519)));
            if(!msg.substring(519, 530).isBlank()) bid_level_9_price = BigDecimal.valueOf(Double.parseDouble(msg.substring(519, 530)));
            ...
            if(!msg.substring(554, 565).isBlank()) ask_level_10_price = BigDecimal.valueOf(Double.parseDouble(msg.substring(554, 565)));
            if(!msg.substring(565, 576).isBlank()) bid_level_10_price = BigDecimal.valueOf(Double.parseDouble(msg.substring(565, 576)));
            ...
            if(!msg.substring(624, 635).isBlank()) estimated_trading_price = BigDecimal.valueOf(Double.parseDouble(msg.substring(624, 635)));
    ...
    public BigDecimal getYesterdayPrice() {
        try {
            return BigDecimal.valueOf(current_price.doubleValue() + getPrice_change_against_the_previous_day().doubleValue());
        } catch (Exception e) {
            return null;
        }
    }
    public double getComparePriceRate() {
        try {
            double value = 0;
            if(current_price.doubleValue() != 0 && getYesterdayPrice() != null) value = (current_price.doubleValue() - getYesterdayPrice().doubleValue()) / getYesterdayPrice().doubleValue() * 100;
            return value;
        } catch (Exception e) {
            return 0;
        }
    ...
    private double getComparePriceRate(Double price) {
        try {
            ...
            double value = 0;
            if(opening_price.doubleValue() != 0 && price != 0) value = (current_price.doubleValue() - price) / price * 100;
            return value;
        } catch (Exception e) {
            return 0;
        }
    ...
    public Map<String, Object> toSocket(Product prod) {
        ...
        //11. 매도 호가 등락률
        response.put("ask_level_1_rate", getComparePriceRate(ask_level_1_price.doubleValue()));
        response.put("ask_level_2_rate", getComparePriceRate(ask_level_2_price.doubleValue()));
        response.put("ask_level_3_rate", getComparePriceRate(ask_level_3_price.doubleValue()));
        response.put("ask_level_4_rate", getComparePriceRate(ask_level_4_price.doubleValue()));
        response.put("ask_level_5_rate", getComparePriceRate(ask_level_5_price.doubleValue()));
        response.put("ask_level_6_rate", getComparePriceRate(ask_level_6_price.doubleValue()));
        response.put("ask_level_7_rate", getComparePriceRate(ask_level_7_price.doubleValue()));
        response.put("ask_level_8_rate", getComparePriceRate(ask_level_8_price.doubleValue()));
        response.put("ask_level_9_rate", getComparePriceRate(ask_level_9_price.doubleValue()));
        response.put("ask_level_10_rate", getComparePriceRate(ask_level_10_price.doubleValue()));
        ...
        response.put("bid_level_1_rate", getComparePriceRate(bid_level_1_price.doubleValue()));
        response.put("bid_level_2_rate", getComparePriceRate(bid_level_2_price.doubleValue()));
        response.put("bid_level_3_rate", getComparePriceRate(bid_level_3_price.doubleValue()));
        response.put("bid_level_4_rate", getComparePriceRate(bid_level_4_price.doubleValue()));
        response.put("bid_level_5_rate", getComparePriceRate(bid_level_5_price.doubleValue()));
        response.put("bid_level_6_rate", getComparePriceRate(bid_level_6_price.doubleValue()));
        response.put("bid_level_7_rate", getComparePriceRate(bid_level_7_price.doubleValue()));
        response.put("bid_level_8_rate", getComparePriceRate(bid_level_8_price.doubleValue()));
        response.put("bid_level_9_rate", getComparePriceRate(bid_level_9_price.doubleValue()));
        response.put("bid_level_10_rate", getComparePriceRate(bid_level_10_price.doubleValue()));
    ...
    public boolean isRealBoard() {
        return board_id != null && board_id.charAt(0) != 'I';
    }
}
